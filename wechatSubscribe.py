...
class WechatSubscribe:
    def __init__(self):
        ...
        self.api = f"https://api.weixin.qq.com/cgi-bin/" \
                   f"message/subscribe/send?access_token={self.access_token}"
    ...
    def sendMsg(self, buying: str, price: str):
        ...
        try:
            result = requests.post(self.api, json=post_data, timeout=3).json()  # 发送订阅消息
        except:
            result = {}
        # print(post_data)
        # print(result)
